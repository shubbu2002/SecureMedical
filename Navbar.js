...
import "./navbar.css";
import healthReport from "../../assets/health-report.png"; // Update with your actual image file
  ...
  return (
    <div className="Navbar">
      <div className="nav__name">
        ...
        <h2>MedicalRecord Storer</h2>
      </div>
      <div className="nav__networkSelector">
        <select name="network" id=" network" onChange={networkHandler} value={config[chainId]?`0x${chainId.toString(16)}`:`0`}>
            <option value="0" disabled>Select Network
            </option>
